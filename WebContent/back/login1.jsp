    ...
    <div id="loginbox">  
        ...
        <form id="recoverform" class="form-vertical" style="padding-top:10px;">
            ...
            <div class="form-actions">
                ...
                <span class="pull-right"><a id="changePwd" onclick="resetPwd()" class="btn btn-info" style="width:310px;">重置密码</a></span>
            </div>
            <div class="control-group normal_text">
                <div style="font-size:14px;color:gray;">版权所有 &copy; 小城故事组 2018</div>
            </div>
...
function resetPwd(){
   ...
   if($("#recoverform").valid()){
	$.ajax({
		url : "${pageContext.request.contextPath}/user/reset.action",
		data : {
			userName:userName1,
			userPwd:newuserPwd
		},
